...
import gdown
import zipfile
from utils.augment import visualize_detection_dataset

visualize_detection_dataset(img_folder='images', ann_folder='annotations', num_imgs=10, img_size=320, augment=True)

train_image_path ="images/"
train_ann_path ="annotations/"
valid_image_path= "images/"
valid_ann_path ="valid/annotations/"

!mkdir -p train/annotations/
!mkdir -p valid/annotations/
