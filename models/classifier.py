...
class Classifier(object):
    ...
    def train(self,
        ...
        train_generator, validation_generator, labels = create_datagen(img_folder, valid_img_folder, batch_size, self._input_size, project_folder, augumentation, self._norm)
